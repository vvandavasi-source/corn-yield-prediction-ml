...
# -*- coding: utf-8 -*-
"""
CORN YIELD 2 — Canonical yield model — V3 AUDITED (B + AWC100 + CEC)
...
MODEL_VERSION = "CY2_CANONICAL_V3_1_AUDITED_AWC100_CEC_SCENARIO_PARSER_FIXED"
...
print("Feature policy   : vegetation + veg anomalies + hist_5yr + year + 15 compact PRISM + AWC100 + 20 CEC")
...
seasonal_results_path = os.path.join(
    OUTPUT_DIR_BASE,
    f"CY2_V3_AWC100_CEC_heldout_{VALIDATION_TAG}_all_DOYs.csv"
)
seasonal_summary_path = os.path.join(
    OUTPUT_DIR_BASE,
    f"CY2_V3_AWC100_CEC_heldout_{VALIDATION_TAG}_seasonal_summary.csv"
)
...
manifest_path = os.path.join(
    ...
    "CY2_CANONICAL_V3_AWC100_CEC_model_spec.json"
...
OUTPUT_DIR_CELL18 = os.path.join(
    OUTPUT_DIR_BASE,
    f"cell18_{VALIDATION_TAG}_AWC100_CEC_icdl_results",
)
...
print()
print("=" * 105)
print("CY2 V3 AUDITED — FINAL B + AWC100 + CEC WORKFLOW COMPLETE")
print("=" * 105)
print("Model version:", MODEL_VERSION)
