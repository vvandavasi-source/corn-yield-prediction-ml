// ============================================================================
// CORN YIELD 2
// PREVIOUS-YEAR CDL MODIS EXTRACTION
...
// OUTPUT:
//
//   Corn_MODIS_2024_PREVIOUS_CDL.csv
//   Corn_MODIS_2025_PREVIOUS_CDL.csv
//
// ONLY 3 EXPORT TASKS.
//
...
// >>> ACTION REQUIRED: this runs on YOUR Earth Engine account.
// The original 2025 CDL path was on another user's account and will NOT
// resolve for you. Upload YOUR processed 2025 CDL as a GeoTIFF image asset,
// then paste its full asset ID below. (Only the 2025 FINAL export uses this.)
var CDL_2025_ASSET =
  'projects/REPLACE_WITH_YOUR_PROJECT/assets/CDL_2025_30m';
...
YEARS.forEach(
  ...
  function(year) {
    ...
    // PREVIOUS-YEAR CDL: mask THIS year's MODIS with LAST year's CDL.
    var finalCDL =
      getFinalCDL(
        year - 1
      );
    ...
    var exportName =
      'Corn_MODIS_' + year + '_PREVIOUS_CDL';
...
print('============================================================');
print('PREVIOUS-YEAR CDL MODIS EXPORT SETUP COMPLETE (2024 + 2025)');
print('============================================================');
print('Years (MODIS):', YEARS);
print('Mask = prior-year NASS CDL: 2023 for 2024, 2024 for 2025');
print('States:', STATE_FIPS.length);
print('DOYs:', DOYS.length);
print('Drive folder:', DRIVE_FOLDER);
print('Expected tasks:');
print('  Corn_MODIS_2024_PREVIOUS_CDL');
print('  Corn_MODIS_2025_PREVIOUS_CDL');
print('Open the Tasks tab and start both exports.');
